...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 跳转充值页面
      onTargetRecharge() {
        this.$navTo('packageA/pages/wallet/recharge/index')
      },

      // 跳转充值记录页面
      onTargetRechargeOrder() {
        // this.$navTo('packageA/pages/wallet/recharge/order')
        this.$navTo('packageA/pages/log/log?payType=wxpay')
      },
